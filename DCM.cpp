...
void DCM::update(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz)
{
...
void DCM::init_rotation_matrix(float yaw, float pitch, float roll)
{
  float c1 = cos(roll);
  float s1 = sin(roll);
  float c2 = cos(pitch);
